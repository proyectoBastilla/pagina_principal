<!-- Final del código, incluye footer y scripts -->
    ...
    <section class="">
      ...
      <div class="row">
        ...
        <div class="col-lg-4 col-md-6 mb-4 mb-md-0">
          ...
          <img src="https://i.ibb.co/yYJTtQS/favicon.png" alt="favicon" border="0" style="height: 190px">
        ...
        <div class="col-lg-3 col-md-6 mb-4 mb-md-0">
          ...
          <br></br>
          <a href="mapa.php">
          <button type="button" class="btn btn-outline-light btn-floating m-1"><h5>Ver más</h5></button></a>
        </div>
        </div>
        </div>
        <!--fin de la columna 3-->
